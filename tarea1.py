...
image.setFileName("randPoint.bmp")
...
image.setFileName("cornerPoints.bmp")
image.glVertex(-1,1)
image.glVertex(-1,-1)
image.glVertex(1,1)
image.glVertex(1,-1)
...
image.setFileName("whiteBorder.bmp")
coe = 1/199
...
image.setFileName("diagonal.bmp")
coe = 1/199
for x in range(199):
...
image.setFileName("blackAndwhite.bmp")
for x in range(-199,199):
...
image.setFileName("randomColor.bmp")
for x in range(-199,199):
	for y in range(-199,199):
...
image.setFileName("centerCube.bmp")
...
image.setFileName("atariScene.bmp")
coex = 1/160
coey = 1/192
